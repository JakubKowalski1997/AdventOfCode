...
int main()
{
    ...
    for(int i = 0; i < 16; i++){
        ...
        roz[i] = max[i] - min[i];
        cout<<"i: "<< i <<" " << max[i]<< " "<<min[i]<<" " << roz[i]<<endl;
        sumRoz += roz[i];
    }
    cout<<"suma roznic "<<sumRoz<<endl;

    int tempDiv = tab[0][0];
    int tempDivDiv = tab[0][0];
